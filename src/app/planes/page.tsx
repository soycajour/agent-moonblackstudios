...
const S = {
  ...
  p: { fontSize: '1rem', lineHeight: 1.6, color: 'oklch(62% 0.01 260)' } as React.CSSProperties,
};
  ...
  return (
    <>
      <main id="main" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: 'var(--bg)', position: 'relative', overflow: 'hidden' }}>
        {/* Background Glow */}
        <div aria-hidden="true" style={{ position: 'absolute', top: '10%', left: '50%', transform: 'translateX(-50%)', width: '90vw', maxWidth: 800, height: 600, background: 'oklch(62% 0.22 27 / 0.03)', borderRadius: '50%', filter: 'blur(120px)', pointerEvents: 'none' }} />
        ...
        <header style={{ width: '100%', maxWidth: '800px', margin: '0 auto', padding: '2rem 1.5rem 1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 10 }}>
          <Link href="/" style={{ fontSize: '0.85rem', fontWeight: 600, color: 'oklch(62% 0.01 260)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ← Volver a la demo
          </Link>
          <span style={{ fontSize: '0.8rem', fontWeight: 800, letterSpacing: '0.25em', textTransform: 'uppercase', color: 'oklch(45% 0.008 260)' }}>
            MoonBlack Studios
          </span>
        </header>
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto', width: '100%', textAlign: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.25rem', marginBottom: '4rem', textAlign: 'left' }}>
              {[
                ...
                <Reveal key={idx} delay={idx * 0.05}>
                  <div style={{ padding: '1.5rem', background: 'var(--surface)', border: '1px solid var(--border-subtle)', borderRadius: '1rem', height: '100%' }}>
                    <h3 style={{ fontSize: '1.05rem', fontWeight: 700, color: 'oklch(96% 0.005 260)', marginBottom: '0.5rem' }}>{cap.title}</h3>
                    <p style={{ fontSize: '0.88rem', color: 'oklch(62% 0.01 260)', lineHeight: 1.5 }}>{cap.desc}</p>
                  </div>
                </Reveal>
              ))}
            </div>
            ...
            <Reveal delay={0.3}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', maxWidth: '700px', margin: '0 auto', textAlign: 'left' }} className="two-col">
                ...
                {/* Monthly Plan */}
                <div style={{ padding: '2.5rem 2rem', background: 'var(--surface)', border: '1px solid var(--border-subtle)', borderRadius: '1.25rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                  <div>
                    <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: 'oklch(96% 0.005 260)', marginBottom: '0.5rem' }}>Mensual</h3>
                    <p style={{ fontSize: '0.9rem', color: 'oklch(62% 0.01 260)', marginBottom: '1.5rem', lineHeight: 1.4 }}>Ideal si quieres probar el sistema primero.</p>
                    <div style={{ marginBottom: '2rem' }}>
                      <span style={{ fontSize: '2.5rem', fontWeight: 800, color: 'oklch(96% 0.005 260)' }}>$497</span>
                      <span style={{ fontSize: '0.9rem', color: 'oklch(62% 0.01 260)' }}>/mes</span>
                    </div>
                  </div>
                ...
                <div style={{ 
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '0.9rem', color: 'oklch(62% 0.01 260)', marginBottom: '1.5rem', lineHeight: 1.4 }}>Prioridad de implementación, configuración preferencial y soporte directo.</p>
                    <div style={{ marginBottom: '2rem' }}>
                      <span style={{ fontSize: '2.5rem', fontWeight: 800, color: 'oklch(96% 0.005 260)' }}>$4,970</span>
                      <span style={{ fontSize: '0.9rem', color: 'oklch(62% 0.01 260)' }}>/año</span>
                    </div>
                  </div>
        ...
        <footer style={{ borderTop: '1px solid var(--border-subtle)', padding: '2rem 0', zIndex: 10 }}>
          <div className="container" style={{ display: 'flex', justifyContent: 'center' }}>
            <span style={{ fontSize: '0.8rem', fontWeight: 600, color: 'oklch(45% 0.008 260)' }}>
